  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      try {
        ...
        const [hives, tasks, survival, yieldReport] =
        ...
        state.hives =
          hives.status === "fulfilled" ? hives.value : [];
        state.tasks =
          tasks.status === "fulfilled" ? tasks.value : [];
        state.survival =
          survival.status === "fulfilled" ? survival.value : null;
        state.yieldReport =
          yieldReport.status === "fulfilled" ? yieldReport.value : null;
      } catch (err: unknown) {
        state.error =
